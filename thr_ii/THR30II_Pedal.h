...
// enum dynModes {Boost, Comp, Gate}; // Currently not used
...
#define TFT_THRVDARKBROWN       tft.color565( 82,  57,  27)
...
#define TFT_THRORANGE5          tft.color565(255, 100, 40)
#define TFT_THRDIMORANGE5       tft.color565(135, 40,  30)
...
#define TFT_THREFFECT    TFT_THRLIME1
#define TFT_THRDIMEFFECT TFT_THRDIMLIME

#define TFT_THRDELAY     TFT_THRSKYBLUE
#define TFT_THRDIMDELAY  TFT_THRDIMSKYBLUE

#define TFT_THRREVERB    TFT_THRORANGE5
#define TFT_THRDIMREVERB TFT_THRDIMORANGE5
///////////////

#define TFT_THRCHOR     TFT_THRLIME1
#define TFT_THRDIMCHOR  TFT_THRDIMLIME
#define TFT_THRFLAN     TFT_THRLIME1
#define TFT_THRDIMFLAN  TFT_THRDIMLIME
#define TFT_THRPHAS     TFT_THRLIME1
#define TFT_THRDIMPHAS  TFT_THRDIMLIME
#define TFT_THRTREM     TFT_THRLIME1
#define TFT_THRDIMTREM  TFT_THRDIMLIME

#define TFT_THRTAPE     TFT_THRSKYBLUE
#define TFT_THRDIMTAPE  TFT_THRDIMSKYBLUE
#define TFT_THRDDLY     TFT_THRSKYBLUE
#define TFT_THRDIMDDLY  TFT_THRDIMSKYBLUE

#define TFT_THRSPR      TFT_THRMAGENTA
#define TFT_THRDIMSPR   TFT_THRDIMMAGENTA
#define TFT_THRPLATE    TFT_THRMAGENTA
#define TFT_THRDIMPLATE TFT_THRDIMMAGENTA
#define TFT_THRROOM     TFT_THRMAGENTA
#define TFT_THRDIMROOM  TFT_THRDIMMAGENTA
#define TFT_THRHALL     TFT_THRMAGENTA
#define TFT_THRDIMHALL  TFT_THRDIMMAGENTA
